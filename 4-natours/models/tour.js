...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [10, 'A tour name must have more or equal to 10 characters'], // Built-In validator
      // validate: [validator.isAlpha, 'Tour name must only contain characters'], // Third party validator
    },
    slug: String,
    duration: {
      type: Number,
